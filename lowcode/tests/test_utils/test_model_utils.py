...
class ModelUtilsTest(TestCase):
    def setUp(self):
        LowCodeModelConfig.objects.create(name="Existing", table_name="lowcode_existing")
    ...
    def test_is_model_name_unique_exclude_self(self):
        obj = LowCodeModelConfig.objects.get(name="Existing")
    ...
    def test_ensure_unique_table_name(self):
        ...
        # 创建冲突
        LowCodeModelConfig.objects.create(name="Test1", table_name=base)
        # 应返回带后缀
